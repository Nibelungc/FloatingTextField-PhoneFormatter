...
+(void) applyFormat:(JVFloatLabeledTextField *)textField forText:(NSString *)text
{
    if (!text) text = @"";
...
+(BOOL)logicTextField:(JVFloatLabeledTextField *)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString *)string
{
...
-(BOOL)textField:(JVFloatLabeledTextField *)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString *)string
{
...
- (BOOL)textFieldShouldClear:(JVFloatLabeledTextField *)textField
{
